...
nbText: """
## Current projects
Here is a concise overview of the main projects I'm actively engaged in at present, encompassing both professional and personal spheres.
This list provides insight into the diverse range of tasks and interests currently occupying my time and attention.

### Professional Projects:
- **[QGIS](https://qgis.org)**: Core Committer
- **[PostGIS](https://postgis.net)**: Core Committer
- **[SFCGAL](https://sfcgal.org)**: Core Committer

### Personal Projects:
- **FreeBSD**:
  - [Desktop Team](https://wiki.freebsd.org/Desktop)
  - [Maintained Ports](https://www.freshports.org/search.php?stype=maintainer&method=exact&query=lbartoletti%40FreeBSD.org&num=100&category=&orderby=category&orderbyupdown=asc&search=Search&format=html&branch=head)
  - Some [CBSD recipes and improvements](https://github.com/cbsd)
- **Nim**:
  - [AccurateSums](https://gitlab.com/lbartoletti/accuratesums): A library for fixed-point calculations.
  - [FixedPointNumber (fpn)](https://gitlab.com/lbartoletti/fpn): A library for fixed-point arithmetic.
  - Soon, Cordic, trigonometric functions, and a pure Nim geometry library
- **Color Themes**:
  - [Lituus](https://github.com/lbartoletti/lituus.nvim): Managing my own color themes.
"""
