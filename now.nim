...
I'm a CAD/GIS engineer passionate about open geospatial technologies.
...
I'm also a FreeBSD [3] [4] ports committer, focusing on the Desktop and Python teams, and contributing to improving GIS tools within the FreeBSD ecosystem. 
My development philosophy revolves around simplicity, lightweight solutions, and effectiveness, with proficiency in languages like C, C++, Python, Nim, and shell scripting.
...
- Contributing to various projects within the [OSGeo](https://osgeo.org/) community to improve open-source geospatial technologies.

#### Personal Projects:
- Developing projects using Nim: 
  ...
  - Soon, releasing a geometry library to complement these projects.
- Involved in embedded systems development.
- Passionate about testing and optimizing old systems to utilize minimal resources.

### 🌱 I’m currently learning:
- [ADA](https://ada-lang.io/)
- [Idris / Type Driven Development](https://www.idris-lang.org/)
- Exploring Lisp languages.
- Continuously improving skills in C, C++, Python, and Nim.
...
This content was inspired by [nownownow.com](https://nownownow.com/).
"""
